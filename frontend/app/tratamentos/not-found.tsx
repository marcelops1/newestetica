...
export default function TratamentosNotFound() {
  return (
    <main className="mx-auto max-w-2xl px-4 py-20 text-center">
      ...
      <p className="mt-4 text-base leading-relaxed text-ink-secondary">
        O endereço pode ter mudado ou o procedimento saiu do catálogo — nada de
        errado com você. Volte ao catálogo e encontre o cuidado certo no seu
        ritmo.
      </p>
      <Link
        href="/tratamentos"
