...
- [ ] 1.2 Rodar quality gates e `openspec validate` e verificar que tudo passa sem tocar em código

## 2. Verificação e archive

- [ ] 2.1 Registrar em `verification.md` a avaliação de segurança (doc puro: sem gatilho docs/07 §7; lacunas de skills da Fase 1 que tocam segurança) e arquivar via `openspec-archive-change` com specs sincronizadas
