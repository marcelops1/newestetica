...
- [ ] 1.1 Escrever o teste das constantes (`blog`→`/blog`, `contato`→`/contato`, `orcamento`→`/orcamento`) e constatar que falha (`undefined` — constantes inexistentes em `NAV_DESTINATIONS`)
...
- [ ] 2.1 Atualizar o teste de ordem do rodapé para os 6 labels (Tratamentos, Resultados, Depoimentos, Diferenciais, Blog, Contato) e constatar que falha (só 4 itens, sem Blog/Contato)
