...
- [x] 1.3 Atualizar `AGENTS.md` §12 (+2 linhas de mapeamento) e docs/07 §13 (Stryker + contrato via skill + nota KISS/YAGNI/SOLID), e verificar com `grep` que os trechos existem e que CI/gates seguem intocados (`grep -r stryker .github/` vazio)
