...
- [x] 3.2 Rodar quality gates e `openspec validate`, registrar em `verification.md` o OWASP (texto livre renderizado como texto, sem HTML cru) e as dispensas (mutation, falha/resiliência, E2E, carga) com justificativa, e arquivar via `openspec-archive-change` com specs sincronizadas
