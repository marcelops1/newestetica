...
- [x] 4.2 Rodar quality gates e `openspec validate`, registrar revisão `security-and-hardening` (gatilho docs/07 §7: consentimento de imagem) em `verification.md`, e arquivar via `openspec-archive-change` com specs sincronizadas
