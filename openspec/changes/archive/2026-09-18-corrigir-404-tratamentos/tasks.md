...
- [x] 2.2 Avaliar `docs/product/08-backlog-produto.md` (atualizar somente se algum status estiver incorreto) e atualizar a linha de `docs/product/05-estado-atual.md` sobre a 404 do catálogo, que esta correção torna obsoleta, verificando consistência
