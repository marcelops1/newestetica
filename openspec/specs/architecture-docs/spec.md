...
`docs/architecture/c2-container.md` SHALL conter diagrama Mermaid com Frontend Next.js (real, detalhando as rotas `/`, `/tratamentos`, `/tratamentos/[slug]`, `/sobre`, `/antes-depois` e `/depoimentos`), Backend NestJS, PostgreSQL e Keycloak (planejados), sem inventar contêineres fora de `docs/02`.
