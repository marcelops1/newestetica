...
flowchart TB
    ...
    subgraph Real
        ...
        BE[Backend NestJS<br/>módulos Agendamento, Catálogo,<br/>Conteúdo Público, Pacientes<br/>e Atendimento<br/>Clean Architecture]
        DB[(PostgreSQL)]
    end
    subgraph Planejado
        K[Keycloak + 2FA]
